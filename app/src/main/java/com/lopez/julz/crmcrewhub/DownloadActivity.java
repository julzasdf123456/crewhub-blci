...
public class DownloadActivity extends AppCompatActivity {
    ...
    public void fetchDownloadableServiceConnections() {
        try {
             ...
             */
            Call<List<ServiceConnections>> serviceConnectionDownloadables = requestPlaceHolder.getForEnergizationData(crew);
             ...
             */
            Call<List<ServiceConnectionInspections>> serviceInspectionCall = requestPlaceHolder.getInspectionsForEnergizationData(crew);
